class CampaignsController < ApplicationController
  ...
  def campaign_params
      params.require(:campaign).permit(
        :title, :body, :project_id, :goal_count,
        :cover_image, :cover_image_cache, :remove_cover_image,
        :social_image, :social_image_cache, :remove_social_image,
        :thanks_mention,
        :comment_enabled, :sign_title, :sign_placeholder,
        :confirm_third_party, :opened_at, :stealthily,
        ...
        :agent_id, :css, :need_stance, :ga_id, :use_sample_mail, :sample_email)
  end
