class Ability
  ...
  def initialize(user, params = {})
    ...
    can [:sign_form, :order_form, :orders, :agents, :comments, :stories, :story, :signers, :pickets, :need_to_order_agents], Campaign
    can [:sign_form, :order_form, :picket_form, :orders, :agents, :comments, :stories, :story, :signers, :pickets, :need_to_order_agents], Campaign
