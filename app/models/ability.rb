class Ability
  ...
  def initialize(user, params = {})
    ...
    can [:sign_form, :order_form, :picket_form, :orders, :agents, :comments, :stories, :story, :signers, :pickets, :picket, :agents, :need_to_order_agents, :widget_v1_sdk, :widget_v1_content, :widget_v1_preview], Campaign
    ...
    if user
      ...
      can [:edit_agents, :add_agent, :remove_agent, :add_action_target, :remove_action_target, :edit_message_to_agent, :update_message_to_agent, :open, :close, :stealthily, :comments_data, :data, :orders_data, :add_agents], [Campaign] do |action|
